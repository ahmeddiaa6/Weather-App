...
def getWeather():
    try:
        ...
        api = (
            ...
            + city
            + "&appid=b8382ad6482909f23bc66ca4df5c927b"
        )
...
# search box
Search_image = PhotoImage(file="imag/search.png")
...
Search_icon = PhotoImage(file="imag/search_icon.png")
myimage_icon = Button(
...
# logo
Logo_image = PhotoImage(file="imag/logo.png")
logo = Label(image=Logo_image)
logo.place(x=150, y=100)

# Bottom box
Frame_image = PhotoImage(file="imag/box.png")
